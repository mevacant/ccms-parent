...
<!-- 微信分享 -->
<script type="text/javascript" src="${basePath}/js/share/jweixin-1.0.0.js"></script>
<script type="text/javascript" src="${basePath}/js/share/wechat.js"></script>
<script type="text/javascript" src="${basePath}/js/share/share.js"></script>
                    ...
                    <form class="form-horizontal" style="">
						...
						<div class="row">
							...
							<div class="col-xs-8" style="text-align: left">
								<input onkeyup="this.value=this.value.replace(/[^\w_]/g,'');" style="width:150px;height: 40px;background: transparent;" type="text" class="line-input" id="codeInput" name="code" placeholder="请输入13位券码">
							</div>
						</div>
